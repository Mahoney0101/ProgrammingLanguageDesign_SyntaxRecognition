...
public class CmmParser extends Parser {
	...
	public static final int
		...
		VOID=7, MAIN=8, WRITE=9, ID=10, CHAR_CONSTANT=11, REAL_CONSTANT=12, INT_CONSTANT=13, 
		STRUCT=14, INT=15, REAL=16, CHAR=17, READ=18, RETURN=19, LBRACE=20, RBRACE=21, 
		LPAREN=22, RPAREN=23, LBRACKET=24, RBRACKET=25, SEMI=26, COMMA=27, ASSIGN=28, 
		ADD=29, SUB=30, MUL=31, DIV=32, MOD=33, GT=34, GTE=35, LT=36, LTE=37, 
		NEQ=38, EQ=39, AND=40, OR=41, NOT=42, DOT=43;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'write'", null, null, null, null, "'struct'", "'int'", "'real'", "'char'", 
			"'read'", "'return'", "'{'", "'}'", "'('", "')'", "'['", "']'", "';'", 
			"','", "'='", "'+'", "'-'", "'*'", "'/'", "'%'", "'>'", "'>='", "'<'", 
			"'<='", "'!='", "'=='", "'&&'", "'||'", "'!'", "'.'"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"VOID", "MAIN", "WRITE", "ID", "CHAR_CONSTANT", "REAL_CONSTANT", "INT_CONSTANT", 
			"STRUCT", "INT", "REAL", "CHAR", "READ", "RETURN", "LBRACE", "RBRACE", 
			"LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "SEMI", "COMMA", "ASSIGN", 
			"ADD", "SUB", "MUL", "DIV", "MOD", "GT", "GTE", "LT", "LTE", "NEQ", "EQ", 
			"AND", "OR", "NOT", "DOT"
		};
	}
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 230528L) != 0)) {
				{
				setState(87);
				paramList();
				}
	...
	public final StructDeclarationContext structDeclaration() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 230528L) != 0) );
			setState(106);
			match(RBRACE);
			setState(107);
			match(ID);
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			case LBRACE:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4398051737296L) != 0)) {
					{
					{
					setState(123);
					blockStatement();
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4398050720768L) != 0)) {
				{
				setState(183);
				exprList();
				}
