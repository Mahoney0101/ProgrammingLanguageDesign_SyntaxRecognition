...
public class CmmLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IF", "ELSE", "WHILE", "VOID", "MAIN", "WRITE", "STRUCT", "INT", "DOUBLE", 
			"CHAR", "READ", "RETURN", "ASSIGN", "LBRACE", "RBRACE", "LPAREN", "RPAREN", 
			"LBRACKET", "RBRACKET", "SEMI", "COMMA", "ADD", "SUB", "MUL", "DIV", 
			"MOD", "GT", "GTE", "LT", "LTE", "NEQ", "EQ", "AND", "OR", "NOT", "DOT", 
			"ID", "CHAR_CONSTANT", "DOUBLE_CONSTANT", "INT_CONSTANT", "ESCAPE_SEQUENCE", 
			"EXPONENT", "ONE_LINE_COMMENT", "MULTI_LINE_COMMENT", "WS"
		};
	}
